...
"Project UMN" is a third-person puzzle game developed for my third semester school project. Players control a robotic entity alongside an AI companion through minimalist simulation tests, making moral choices that explore the balance between efficiency and companionship. The story unfolds entirely through environmental design, with no text or dialogue.
...
- Dynamic lighting and emission system that adapts to environment conditions, with special aiming mode enhancements when the player needs precision targeting.
...
This project helped me develop skills with C# interfaces, abstract classes, Unity's Shader Graph, Scriptable Objects, and animation tweening libraries.
